...
1. The review layers are `the workflow setting `review_layers``, resolved during activation.

2. For each layer in `the workflow setting `review_layers``:
