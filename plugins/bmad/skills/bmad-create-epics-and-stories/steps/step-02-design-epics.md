...
- 💾 Update {{epics_list}} in the workspace planning-artifacts directory/epics.md
...
After approval, update the workspace planning-artifacts directory/epics.md:
...
- IF C: Save approved epics_list to the workspace planning-artifacts directory/epics.md, update frontmatter, then read fully and follow: ./step-03-create-stories.md
