...
- ✅ YOU MUST ALWAYS SPEAK OUTPUT In your Agent communication style with the config `the user-provided language`
...
- 💾 Populate the workspace planning-artifacts directory/epics.md with extracted requirements
...
Welcome the user-provided name to comprehensive epic and story creation!
...
1. `the workspace planning-artifacts directory/*prd*.md` (whole document)
2. `the workspace planning-artifacts directory/*prd*/index.md` (sharded version)

**Architecture Document Search Priority:**

1. `the workspace planning-artifacts directory/*architecture*.md` (whole document)
2. `the workspace planning-artifacts directory/*architecture*/index.md` (sharded version)

**UX Design Document Search (Optional):**

1. `the workspace planning-artifacts directory/ux-designs/ux-*/DESIGN.md` and `the workspace planning-artifacts directory/ux-designs/ux-*/EXPERIENCE.md` (bmad-ux spine pair)
2. `the workspace planning-artifacts directory/*ux*.md` (legacy whole document)
3. `the workspace planning-artifacts directory/*ux*/index.md` (legacy sharded version)
...
Before proceeding, Ask the user if there are any other documents to include for analysis, and if anything found should be excluded. Wait for user confirmation. Once confirmed, create the the workspace planning-artifacts directory/epics.md from the ../templates/epics-template.md and in the front matter list the files in the array of `inputDocuments: []`.
...
Load ../templates/epics-template.md and initialize the workspace planning-artifacts directory/epics.md:

1. Copy the entire template to the workspace planning-artifacts directory/epics.md
2. Replace {the project name from the user or workspace} with the actual project name
...
After extraction and confirmation, update the workspace planning-artifacts directory/epics.md with:
...
- IF C: Save all to the workspace planning-artifacts directory/epics.md, update frontmatter, then read fully and follow: ./step-02-design-epics.md
