...
- 💾 Append epics and stories to the workspace planning-artifacts directory/epics.md following template
...
Load the workspace planning-artifacts directory/epics.md and review:
...
- Append it to the workspace planning-artifacts directory/epics.md following template structure
...
The final the workspace planning-artifacts directory/epics.md must follow this structure exactly:
...
- IF C: Save content to the workspace planning-artifacts directory/epics.md, update frontmatter, then read fully and follow: ./step-04-final-validation.md
