...
- **Catalog**: `the current VS Code workspace root/workspace-local BMAD/_config/bmad-help.csv` — assembled manifest of all installed module skills
...
- Present all output in `the user-provided language`
