...
status: final
sources:
  - the workspace planning-artifacts directory/prds/drift-2026-03-12/prd.md
updated: 2026-04-02
---
...
| Stale data | Project detail | If background refresh detects changes, shadcn `Toast`: "Updated by the user-provided name. Refresh." Manual refresh, no auto. |
