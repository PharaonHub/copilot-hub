...
- `story_key` is unset
- `the workspace setting `implementation_artifacts`/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `the workspace setting `implementation_artifacts`/sprint-status.yaml` file.
