...
```json
{
  "status": "complete",
  "files": [
    "workspace-output/specs/spec-quarter-drop/SPEC.md",
    "workspace-output/specs/spec-quarter-drop/glossary.md",
    "workspace-output/specs/spec-quarter-drop/.memlog.md"
  ]
}
```
