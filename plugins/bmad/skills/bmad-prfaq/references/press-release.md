...
After each section is refined, append it to the output document at `the workspace planning-artifacts directory/prfaq-the project name from the user or workspace.md`. Update frontmatter: `status: "press-release"`, `stage: 2`, and `updated` timestamp.
