**Language:** Use `the user-provided language` for all output.
**Output Language:** Use `the requested output language` for documents.
**Output Location:** `the workspace planning-artifacts directory`
...
**Always produce the distillate** at `the workspace planning-artifacts directory/prfaq-the project name from the user or workspace-distillate.md`:

```yaml
---
title: "PRFAQ Distillate: the project name from the user or workspace"
type: llm-distillate
source: "prfaq-the project name from the user or workspace.md"
created: "{timestamp}"
...
"Your PRFAQ for the project name from the user or workspace has survived the gauntlet.

**PRFAQ:** `the workspace planning-artifacts directory/prfaq-the project name from the user or workspace.md`
**Detail Pack:** `the workspace planning-artifacts directory/prfaq-the project name from the user or workspace-distillate.md`
...
```json
{
  "status": "complete",
  "prfaq": "the workspace planning-artifacts directory/prfaq-the project name from the user or workspace.md",
  "distillate": "the workspace planning-artifacts directory/prfaq-the project name from the user or workspace-distillate.md",
...
Confirm the verdict in the conversation and record it in the workspace artifact.
